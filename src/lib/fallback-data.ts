...
export const sessionTapes: SessionTape[] = [
    ...
    comments: [
      {
        ...
        author: "Marina K.",
        date: "2024-11-13",
        text: "This resonates deeply. The idea of architecture as sensory deprivation rather than stimulation is something I\u2019ve been thinking about in my own practice.",
        likes: 14,
      },
      {
        id: "2",
        author: "Thomas R.",
        date: "2024-11-14",
        text: "Beautiful writing. The line about concrete achieving the status of rock without geological time-scale is perfect.",
        likes: 8,
      },
      {
        id: "3",
        author: "Ava Chen",
        date: "2024-11-15",
        text: "I\u2019d love to see this expanded into a series. What are your thoughts on the Barbican as a case study?",
        likes: 5,
      },
    ],
    commentCount: 3,
  },
  {
    ...
    date: "2024-10-28",
    readingTime: "8 min",
    excerpt: "We interact with hundreds of systems every day without a second thought.",
    content: [
    ...
    comments: [
      {
        ...
        author: "James L.",
        date: "2024-10-29",
        text: "The door analogy is perfect. Don Norman would approve.",
        likes: 22,
      },
      {
        id: "5",
        author: "Priya S.",
        date: "2024-10-30",
        text: "This is why I love working with you. You think about the invisible things.",
        likes: 11,
      },
    ],
    commentCount: 2,
  },
  {
    ...
    date: "2024-09-15",
    readingTime: "6 min",
    excerpt: "White space is not the absence of design. It is design at its most deliberate.",
    content: [
    ...
    comments: [
      {
        ...
        author: "Elena V.",
        date: "2024-09-16",
        text: "This is exactly the design philosophy I aspire to. Less really is more when it\u2019s intentional.",
        likes: 18,
      },
    ],
    commentCount: 1,
...
export const timelineEntries: TimelineEntry[] = [
  {
    id: "1",
    date: "2026-03-26",
    text: "Shipping something this week that I\u2019ve been thinking about for months. The gap between idea and execution is where most things die. Not this one.",
    type: "thought",
    likes: 42,
    comments: 7,
  },
  {
    id: "2",
    date: "2026-03-24",
    text: "The best design systems aren\u2019t the ones with the most components. They\u2019re the ones where every component earns its place. Pruning > adding.",
    type: "linkedin",
    likes: 187,
    comments: 23,
  },
  {
    id: "3",
    date: "2026-03-21",
    text: "Re-reading \u2018A Pattern Language\u2019 by Christopher Alexander. Every time I pick it up I find something new. Architecture as a generative grammar for human experience.",
    type: "reflection",
    likes: 31,
    comments: 4,
  },
  {
    id: "4",
    date: "2026-03-18",
    text: "Hot take: most \u2018minimal\u2019 designs aren\u2019t minimal\u2014they\u2019re just empty. True minimalism is the result of ruthless prioritization, not aesthetic laziness.",
    type: "linkedin",
    likes: 412,
    comments: 56,
  },
  {
    id: "5",
    date: "2026-03-14",
    text: "Spent the morning in a concrete parking garage thinking about light. The way it falls through the gaps between levels creates these perfect horizontal bands. Brutalism by accident.",
    type: "thought",
    likes: 28,
    comments: 3,
  },
  {
    id: "6",
    date: "2026-03-10",
    text: "The tools we choose shape the things we make. I\u2019ve been moving between Figma and code more fluidly lately, and it\u2019s changing how I think about both.",
    type: "linkedin",
    likes: 234,
    comments: 31,
  },
  {
    id: "7",
    date: "2026-03-07",
    text: "Every great product I\u2019ve seen starts with someone saying \u2018what if we just didn\u2019t do that?\u2019 Subtraction is the hardest design skill.",
    type: "thought",
    likes: 89,
    comments: 12,
  },
  {
    id: "8",
    date: "2026-03-03",
    text: "Coffee, silence, a blank page. Some days the work is just sitting with the problem. Not solving\u2014absorbing.",
    type: "reflection",
    likes: 56,
    comments: 8,
  },
  {
    id: "9",
    date: "2026-02-27",
    text: "Thinking about the difference between a platform and a product. A product solves a problem. A platform enables solutions. The shift is subtle but everything.",
    type: "linkedin",
    likes: 301,
    comments: 44,
  },
  {
    id: "10",
    date: "2026-02-22",
    text: "Typography is the voice of design. Choose a typeface like you\u2019d choose your words\u2014deliberately, with awareness of tone and context.",
    type: "thought",
    likes: 67,
    comments: 9,
  },
